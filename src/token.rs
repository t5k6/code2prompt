...
use colored::*;
use tiktoken_rs::{o200k_base, cl100k_base, p50k_base, p50k_edit, r50k_base, CoreBPE};
...
///                Supported encodings: "o200k_base" (default), "cl100k", "p50k", "p50k_edit", "r50k", "gpt2".
///
/// # Returns
///
/// * `CoreBPE` - The tokenizer corresponding to the specified encoding.
pub fn get_tokenizer(encoding: &Option<String>) -> CoreBPE {
    match encoding.as_deref().unwrap_or("o200k_base") {
...
pub fn count_tokens(rendered: &str, encoding: &Option<String>) {
    let (bpe, model_info) = match encoding.as_deref().unwrap_or("o200k_base") {
        "o200k_base"    => (o200k_base(), "GPT-4o models, o1 models"),
        ...
        _ => (o200k_base(), "GPT-4o models, o1 models"),
    };
